class TabLink {
  constructor(tabElement){
    ...
    // this.tabData = this.tabElement.querySelectorAl(`.data-tab`);
    // this.tabData = this.tabElement.querySelector(`.data-tab`);
    // this.tabData = document.querySelector(`.data-tab[tab='${this.data}']`);
    // console.log(tabData);
    ...
    if(this.tabData === 'all') {
      ...
      // this.cards = document.querySelector(`.card[data-tab='${this.card}']`);
    }
    // /* <- Delete this comment block when you work on the if statement
    ...
    // this.cards = Array.from(this.cards).map( (TabCard) => new TabCard(this.card));
    
    // or 
    // this.cards = Array.from(this.cards).map( (TabCard) => cards.push(card));
